...
<head>
    ...
    <title>非信用卡支付商店訂單退款 API 範例程式</title>
</head>

<body>
    <h1>非信用卡支付商店訂單退款 API 範例</h1>
    <form action="refund_api.php" method="post">
        <fieldset>
            <legend>參數輸入</legend>
            <table border="1">
                <tr>
                ...
                <tr>
                    <td>退款金額:</td>
                    <td><input type="number" name="RefundAmt" max="9999999999" required><span style="color:red;">※必填</span></td>
                </tr>
                <tr>
                    <td>時間戳記:</td>
