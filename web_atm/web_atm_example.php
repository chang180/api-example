...
<head>
    ...
    <title>WebATM 串接 API 範例程式</title>
</head>

<body>
    <h1>WebATM 串接 API 範例</h1>
    <form action="web_atm_api.php" method="post">
        <fieldset>
            <legend>參數輸入</legend>
            <table border="1">
                <tr>
                    <td>API網址：</td>
                    <td><input name="url" value="https://ccore.newebpay.com/API/gateway/webatm" size="60" required><span style="color:red;">※必填</span></td>
                </tr>
                <tr>
                    <td>商店代號:</td>
                ...
                <tr>
                    <td>支付完成返回商店網址:</td>
                    <td><input name="ReturnURL" value="您的網址/return_url.php" maxlength="50"><span style="color:red;">※必填</span></td>
                </tr>
                <tr>
                    <td>支付通知網址(選填):</td>
