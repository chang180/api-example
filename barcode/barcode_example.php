...
<head>
    ...
    <title>條碼繳費-幕後取號串接 API 範例程式</title>
</head>

<body>
    <h1>條碼繳費-幕後取號串接 API 範例</h1>
    <form action="barcode_api.php" method="post">
        <fieldset>
            <legend>參數輸入</legend>
            <table border="1">
                <tr>
                    <td>API網址：</td>
                    <td><input name="url" value="https://ccore.newebpay.com/API/gateway/barcode" size="60" required><span style="color:red;">※必填</span></td>
                </tr>
                <tr>
                    <td>商店代號:</td>
