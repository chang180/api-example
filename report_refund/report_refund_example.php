...
<head>
    ...
    <title>單日撥款提領明細查詢 API 範例程式</title>
</head>

<body>
    <h1>單日撥款提領明細查詢 API 範例</h1>
    <form action="report_refund_api.php" method="post">
        <fieldset>
            <legend>參數輸入</legend>
            <table border="1">
                <tr>
                    <td>API網址：</td>
                    <td><input name="url" value="https://ccore.newebpay.com/API/ReportFund/Query" size="60" required><span style="color:red;">※必填</span></td>
                </tr>
                <tr>
                    <td>商店代號:</td>
                ...
                <tr>
                    ...
                    <td>撥款提領日期:</td>
                    <td><input name="FundTime" type="date" style="width:170px;" required><span style="color:red;">※必填</span></td>
                </tr>
                <tr>
                    <td>時間戳記:</td>
